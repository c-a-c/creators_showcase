  ...
  try {
    ...
    return (
      <div className="text-center py-16">
        <h1 className="text-2xl font-semibold mb-2">設定を取得できませんでした</h1>
        <p className="text-gray-600 dark:text-gray-400">{message}</p>
        <p className="text-gray-600 dark:text-gray-400 mt-4">DriveのフォルダIDと認証情報を確認してください。</p>
      </div>
    );
  }
...
export default function Home() {
  return (
    <Suspense fallback={<div className="text-center py-12">設定を取得しています…</div>}>
      <ConfigContent />
    </Suspense>
  );
}